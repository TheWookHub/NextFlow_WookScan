...
AVARDA = function(case_path,thresh,dict_path,total_path,pairwise_path,blast_path,out_path,out_name,avarda_names){
  ...
  case = data.frame(fread(case_path, data.table = FALSE,check.names = FALSE, header = TRUE)) # this is the case of interest to be analyzed - changeable
  ...
  # print("------------------------------")
  # print("")
  # print(head(avarda_names))
  # print(dim(avarda_names))
  ...
  # print("Check Pt 2 - CPU Parallel Setting")
...
input[[3]] = "/home/preston/PhIPSeq-Pipelines/AVARDA_Runs/TestAVARDA/blastp_peptide_edges.csv"

# Input4: path to precomp table listing each viruses abundance in #
# VirScan (does not change if using Virscan)                      #
input[[4]] = "/home/preston/PhIPSeq-Pipelines/AVARDA_Runs/TestAVARDA/repSeq_tblastn_output_bitscore80plus_total_probabilities.csv"

# Input5: path to precomp table listing each viruses relative representation #
# compared with other viruses (doesn't change)                               #
input[[5]] = "/home/preston/PhIPSeq-Pipelines/AVARDA_Runs/TestAVARDA/repSeq_tblastn_output_bitscore80plus_unique_probabilities_xr.csv"

# Input6: path to precomp matrix of Virscan peptide - virus alignments #
input[[6]] = "/home/preston/PhIPSeq-Pipelines/AVARDA_Runs/TestAVARDA/repSeq_tblastn_output_bitscore80plus_bitscore.csv"

# Input7: Output path #
input[[7]] = "/home/preston/PhIPSeq-Pipelines/AVARDA_Runs/Test03"

# Input8: Name of study #
input[[8]] = "UNSW_FullVIR3_Test_SmallVer_"

# Input9: Table converting between dataset names and avarda names #
# This one is pure VIR3 peptide ids. We fixed the probability tables, 
# the network edge table as well as the blast peptide id to Viruses table
input[[9]] = "/home/preston/PhIPSeq-Pipelines/AVARDA_Runs/TestAVARDA/WOOKIES_virlib.names_no91273.csv"
